...
%         load([datpth0,'/bovine_lidocaine_1mA_files.mat']) % cautery files
    case 'ENGS57Demo'
         datpth0      = 'S:/eit/Allaire/ex_vivo_probe/ENGS57Demo'; %*must use / not \
         I = 1e-4; % 1mA 
         file_nms={'metal_topright/setup_full_00001/setup_full_00001_1.eit'};
         ref_nm='saline0o2/setup_full_00001/setup_full_00001_1.eit';
end
...
if outer == 8
    ...
    eval(['load ../make_new_mesh/dat/optmesh',num2str(iter),'_',geo_str,'_large_circleEs_sk msh'])
end
%--------------------------------------------------------------------------
